// Intended for use with a TTGO OLED LoRa ESP32 board.
// LoRa Repeater programmable over USB serial link
...
void setup()
{
  ...
  display.print("LoRa Repeater V1.0");
  display.display();
  ...
  Serial.println("");
  Serial.println("TTGO LoRa USB Repeater");
...
void ShowSettings(void)
{
  ...
  display.print("Rx: ");
  display.print(Settings.Rx.Frequency, 4);
  display.print("MHz");
  display.setCursor(0,20);
  display.print("Tx: ");
  display.print(Settings.Tx.Frequency, 4);
  display.print("MHz");
  display.display();
}
